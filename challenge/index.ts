...
const appClient = new HelloWorldClient(
  {
    ...
    sender: deployer,
    creatorAddress: deployer.addr, // added addr property
  },
  algod, // must be algo client
)

await appClient.create.createApplication({});

// TODO: change YOUR_NAME to your name or nickname
const result = await appClient.helloWorld({name: "Riggy"}, {sendParams: {suppressLog: true}})
